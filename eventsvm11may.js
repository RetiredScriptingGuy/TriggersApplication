...
function myCustomPage() {
    ...
    $('#events tbody')
        .on('click', 'tr', function () {
            ...
            var eventTitle = dataTableEvents.row(this).data().MajorProgramKeyEventsProducts;
            $('#selectedRow').val(eventTitle);
...
function GetEvent(eventname) {
    ...
    var baseUrl = appweburl + "/_api/web/lists/getbytitle('" + listname + "')/items?";
    var filterUrl = "&$filter = MajorProgramKeyEventsProducts eq '" + eventname + "'";
    var fullUrl = baseUrl + filterUrl;
    var requestHeaders = { "accept": "application/json;odata=verbose" };
