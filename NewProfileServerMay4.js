    ...
    $("#ddlType")
        .on("change",
            function () {
                ...
                var usertypeitem = this.value;
                console.log("creating a new user: " + usertypeitem);
...
function LoadUser() {
    ...
    console.log("Creating new profile for " + currentUser);
...
function AddUser() {
    ...
    var  userProfileType = $('#ddlType option:selected').text();

    if (userProfileType == "Competency") {
        userTD = $('#ddlTD option:selected').text();
        if (userTD == "Yes") {
            $("#userAdmin").val("Yes");
            userAdmin = "Yes";
        ...
        if (userTD == "No") {
            $("#userAdmin").val("No");
            userTier3 = $('#ddlTier3 option:selected').text();
            userCompetency = $("#ddlCompetency option:selected").text();
    ...
    if (userProfileType == "PEO") {
        userPEOL = $('#ddlPEOL option:selected').text();
        if (userPEOL == "Yes") {
            $("#userAdmin").val("Yes");
            $("#userProgram").val("ALL");
            userPEO = "NA";
        ...
        if (userPEOL == "No") {
            userPMA = $('#ddlPMA option:selected').text();
            userPSM = $('#ddlPSM option:selected').text();
            if (userPSM == "Yes") {
                $("#userAdmin").val("Yes");
                $("#userProgram").val("ALL");
                userPEO = "NA";
            ...
            if (userPSM == "No") {
                $("#userAdmin").val("No");
                userPEO = $('#ddlPEO option:selected').text();
                userProgram = $('#ddlProgram option:selected').text();
                $("#userProgram").val(userProgram);
                userACAT = $('#ddlACAT option:selected').text();
                userPhase = $('#ddlPhase option:selected').text();
            }
        }
        userCompetency = "NA";
        userTD = "NA";
...
function successUserAddedHandler() {
    console.log("Your profile has been added successfully. You are being logged in.");
...
function errorUserAddedHandler(data, errorCode, errorMessage) {
    ...
    console.log("failed to create user : " + errorCode + errMsg);
